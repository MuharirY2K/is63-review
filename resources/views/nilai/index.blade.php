        ...
        <form method="GET" action="{{ route('nilai.index') }}">
            <div class="form-row align-items-end">
                ...
                <div class="form-group col-md-2 mb-2">
                    ...
                    <input type="number" name="tahun_akademik" value="{{ request('tahun_akademik') }}" class="form-control form-control-sm" placeholder="2023">
                </div>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('mahasiswa.show', $nilai->mahasiswa) }}" class="font-weight-bold">
